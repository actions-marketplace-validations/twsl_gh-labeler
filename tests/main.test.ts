...
const { sampleConfig, configWithContentRules } =
  await import("./fixtures/config");
const {
  createIssuePayload,
  createPullRequestPayload,
  createDiscussionPayload,
} = await import("./fixtures/payloads");
const { setupDefaultMocks, resetMocks } =
  await import("./fixtures/testHelpers");
const {
  ...
  describe("run function", () => {
    describe("action configuration validation", () => {
      ...
      it("should handle validation errors", async () => {
        ...
        validation.default.validate.mockReturnValueOnce(
          validation.mockValidationError as any,
        );
    ...
    describe("handler error scenarios", () => {
      beforeEach(() => {
        ...
        handlers.PullRequestHandler.mockImplementation(
          () => handlers.mockPullRequestHandlerInstance,
        );
        handlers.DiscussionHandler.mockImplementation(
          () => handlers.mockDiscussionHandlerInstance,
        );
      });
