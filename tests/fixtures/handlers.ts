...
export const ContentLabelHandler = jest.fn().mockImplementation(() => mockContentLabelHandlerInstance);
export const IssueHandler = jest.fn().mockImplementation(() => mockIssueHandlerInstance);
export const PullRequestHandler = jest.fn().mockImplementation(() => mockPullRequestHandlerInstance);
export const DiscussionHandler = jest.fn().mockImplementation(() => mockDiscussionHandlerInstance);
